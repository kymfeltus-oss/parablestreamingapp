...
# The new image URL to use
NEW_HERO_IMAGE = "https://images.pexels.com/photos/2774556/pexels-photo-2774556.jpeg?auto=compress&cs=tinysrgb&w=1600"

files = {
    "app/discover/page.tsx": f"""import Navbar from "@/components/Navbar";
        ...
        <main className="flex-1 lg:ml-64 p-6">
            ...
            <div className="mb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                 <div className="col-span-1 md:col-span-2 aspect-video bg-gradient-to-br from-violet-900 to-black rounded-xl relative overflow-hidden group cursor-pointer border border-white/10">
                    {/* --- UPDATED IMAGE LINE HERE --- */}
                    <img src="{NEW_HERO_IMAGE}" className="absolute inset-0 w-full h-full object-cover opacity-80 group-hover:scale-105 transition duration-700"/>
...
for filepath, content in files.items():
    with open(filepath, "w", encoding="utf-8") as f:
        f.write(content)
    print(f"✅ Updated image in: {filepath}")