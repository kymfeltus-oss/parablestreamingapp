...
print("⛪ Building the AI Sanctuary Module...")

# 1. NEW SANCTUARY PAGE (Live Service Experience)
sanctuary_code = """import Navbar from "@/components/Navbar";
...
# 2. UPDATE NAVBAR (Add Sanctuary Link)
...
const links = [
  { href: "/", label: "Home" },
  { href: "/sanctuary", label: "🔴 Sanctuary" }, // <--- HIGHLIGHTED
...
write_file("app/sanctuary/page.tsx", sanctuary_code)
